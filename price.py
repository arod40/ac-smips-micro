...
def main():
    ...
    #---Lo que hay que cambiar para arreglarlo
    #args.detailed
    #args.circuit_name
    #args.output
    #args.file
    input_file = 'D:/School/2do Anno/2do Semestre/2017/AC I/Proyecto 2017 v1.1/s-mips(Cache bug fixed).circ' # "s-mips.circ"
    output_file = "resultGENERAL.json" # "result.json"
    circuit_name = "S-MIPS" # "S-MIPS"
